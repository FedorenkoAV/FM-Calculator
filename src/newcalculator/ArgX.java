...
/**
 * Created by User on 12.06.2017. ArgX это переменная, в которой в текстовом
 * виде хранятся мантисса и экспонента
 */
class ArgX {
...
//    }
     ...
     * мантиссу числа. Если число не в экспоненциальной форме, то функция
     * возвращает строковую переменную без изменений
     *
     * @param SBNumber - строковая переменная, содержащая число в
     ...
     * @param SBNumber - строковая переменная, содержащая число в
     * экспоненциальной форме.
     * @return SBExponent - строковая переменная, содержащая экспоненциальную
     * часть числа.
     */
