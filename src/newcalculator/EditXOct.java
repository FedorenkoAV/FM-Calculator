...
class EditXOct {
    ...
    public EditXOct(Object objStore[]) {
        ...
        calcpress = false;
        newArg();
        Log.d(TAG, "Создали новый ArgXOct.");
//        makeArg();
//        Log.d(TAG, "Отобразили на дисплее.");
        Log.d(TAG, "EditXOct успешно создан!");
    }
    ...
    void setNumber(int intNumber) {
        argX.setNumber(intNumber);
        Log.d(TAG, "В argXOct записали: " + intNumber);
        makeArg();
    ...
    void setNumber(long longNumber) {
        argX.setNumber(longNumber);
        Log.d(TAG, "В argXOct записали: " + longNumber);
        makeArg();
        Log.d(TAG, "Отобразили на дисплее: " + argX.getNumber());
    }
    ...
    void setNumber(double doubleNumber) {
        argX.setNumber(doubleNumber);
        Log.d(TAG, "В argXOct записали: " + doubleNumber);
        makeArg();
        Log.d(TAG, "Отобразили на дисплее: " + argX.getNumber());
    }
